...
|----------|----------|------------|-----------------|
| SQL | StrataScratch | Easy → Medium | 29 |
| Python | LeetCode | Easy (Arrays, Hash Maps) | 5 |
| Pandas | LeetCode | Intro to Pandas | 4 |
...
| File | Topics |
|------|--------|
| `filtering.sql` | WHERE, IS NULL, IN, AND/OR, range conditions |
| `aggregations.sql` | COUNT, SUM, AVG, GROUP BY, HAVING, DISTINCT, NULL ratio |
| `joins.sql` | INNER JOIN, LEFT JOIN, ON conditions |
...
*Updated regularly — commit history reflects daily practice streaks.*
